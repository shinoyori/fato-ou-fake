...
const ADVANCED_METHODS = [
  ...
  { id:"roberta",  tag:"RoBERTa",name:"RoBERTa",           desc:"BERT otimizado e robusto" },
  { id:"gpt",      tag:"GPT",    name:"GPT fine-tuned",    desc:"Geração + classificação" },
  { id:"deberta",  tag:"DeBERTa",name:"DeBERTa",           desc:"Atenção disentangled" },
];
